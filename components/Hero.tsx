...
const Hero: React.FC<HeroProps> = ({ onScheduleClick, onViewGallery }) => {
  return (
    <section className="relative min-h-[75vh] md:min-h-[90vh] flex items-center pt-20 pb-12 md:pt-44 md:pb-32 overflow-hidden bg-white" aria-labelledby="hero-title">
